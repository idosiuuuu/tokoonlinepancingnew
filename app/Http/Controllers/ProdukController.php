...
class ProdukController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        if ($produk->foto) {
            ...
            $mainFile = $directory . $produk->foto;
        ...
        return redirect()->route('backend.produk.index')->with('success', 'Data produk berhasil dihapus.');
    }
    ...
    public function cetakProduk(Request $request)
    {
        ...
        $query =  Produk::whereBetween('created_at', [$tanggalAwal, $tanggalAkhir])
            ->orderBy('id', 'desc');
