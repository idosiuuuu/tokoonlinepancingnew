                ...
                <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark"
                    ...
                    <ul aria-expanded="false" class="first-level collapse">
                        ...
                        <li class="sidebar-item"><a href="{{ route('backend.produk.index') }}" class="sidebar-link"><i
                                    class="mdi mdi-cart"></i><span class="hide-menu"> Produk </span></a>
                        </li>
                    </ul>
                </li>
                <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark"
                        href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-package"></i><span
                            class="hide-menu">Data Pesanan </span></a>
                    <ul aria-expanded="false" class="first-level collapse">
                        <li class="sidebar-item"><a href="{{ route('pesanan.proses') }}" class="sidebar-link"><i
                                    class="mdi mdi-clipboard"></i><span class="hide-menu"> Pesanan</span></a>
                        </li>
                        <li class="sidebar-item"><a href="{{ route('pesanan.selesai') }}" class="sidebar-link"><i
                                    class="mdi mdi-cart"></i><span class="hide-menu"> Pesanan Selesai </span></a>
                        </li>
                    </ul>
                </li>
                <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark"
                    ...
                    <ul aria-expanded="false" class="first-level collapse">
                        <li class="sidebar-item"><a href="{{ route('backend.laporan.formuser') }}"
                                class="sidebar-link"><i class="mdi mdi-chevron-right"></i><span class="hide-menu"> User
                                </span></a></li>
                        <li class="sidebar-item"><a href="{{ route('backend.laporan.formproduk') }}"
                                class="sidebar-link"><i class="mdi mdi-chevron-right"></i><span class="hide-menu">
                                    Produk </span></a></li>
                        <li class="sidebar-item"><a href="{{ route('backend.laporan.formorderproses') }}"
                                class="sidebar-link"><i class="mdi mdi-chevron-right"></i><span class="hide-menu">
                                    Pesanan Proses </span></a></li>
                    </ul>
                </li>
