    ...
    <div class="col-md-12">
        <div class="order-summary clearfix">
            ...
            @if (session()->has('error'))
                ...
                @endif @if ($order && $order->orderItems->count() > 0)
                    <table class="shopping-cart-table table">
                        ...
                        <tbody> @php
                            $totalHarga = 0;
                            $totalBerat = 0;
                        @endphp @foreach ($order->orderItems as $item)
                                @php
                                ...
                                <tr>
                                    <td class="thumb"><img
                                            ...
                                            alt=""></td>
                                    <td class="details"> <a>{{ $item->produk->nama_produk }}</a>
                                        <ul>
                                    ...
                                    <td colspan="2" class="qty text-center"> <a> {{ $item->quantity }} </a> </td>
                                    <td colspan="2" class="total text-center"><strong class="primary-color">Rp.
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <th colspan="2" class="sub-total text-center">Rp.
                            ...
                            <tr>
                                ...
                                <td colspan="2" width="100px">
                                    ...
                                    {{ $order->kurir . '.' . $order->layanan_ongkir . ' *estimasi ' . $order->estimasi_ongkir }}
                                    <br><br>
                                    <p>
                                        Kota asal : {{ $kota_asal }}
                                        <br><br>
                            ...
                            <tr>
                                ...
                                <th colspan="2" class="total text-center">Rp.
                                    {{ number_format($totalHarga + $order->biaya_ongkir, 0, ',', '.') }}</th>
                            </tr>
                        </tfoot>
                    </table> <input type="hidden" name="total_price" value="{{ $totalHarga }}"> <input type="hidden"
                        name="total_weight" value="{{ $totalBerat }}">
                    <div class="pull-right"> <button class="primary-btn" id="pay-button">Bayar Sekarang</button> </div>
                @else
